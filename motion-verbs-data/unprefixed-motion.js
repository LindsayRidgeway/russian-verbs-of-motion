...
window.unprefixedMotionData = {
  ...
  groups: [
    ...
    },
    {
      ...
      aspect: "perfective",
      sentences: [
        { english: "I will set off to the lake (male)", russian: "я пойду к озеру" },
        { english: "I will set off to the lake (female)", russian: "я пойду к озеру" },
        { english: "She will set off to the forest", russian: "она пойдёт в лес" },
        { english: "He will drive off to the cinema", russian: "он поедет в кино" },
        { english: "We will drive off to the airport", russian: "мы поедем в аэропорт" },
        { english: "They will set off up the hill", russian: "они пойдут на холм" },
        { english: "You will drive off to the hospital", russian: "вы поедете в больницу" },
        { english: "The kids will set off to the playground", russian: "дети пойдут на площадку" },
        ...
        { english: "He will set off into the woods", russian: "он пойдёт в лес" },
        { english: "They will drive off to the restaurant", russian: "они поедут в ресторан" },
        { english: "The visitor will set off to the waterfall (male)", russian: "посетитель пойдёт к водопаду" },
        { english: "The visitor will set off to the waterfall (female)", russian: "посетительница пойдёт к водопаду" },
        { english: "The group will set off to the summit", russian: "группа пойдёт на вершину" },
        { english: "She will drive off across the bridge", russian: "она поедет по мосту" },
        { english: "We will set off along the creek", russian: "мы пойдём вдоль ручья" },
        { english: "He will drive off to the theater", russian: "он поедет в театр" },
        { english: "They will set off through the valley", russian: "они пойдут по долине" },
